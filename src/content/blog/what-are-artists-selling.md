---
title: "What Are Artists  Selling? Investing in Hybrid Arts, pt. III: Demand / Markets"
date: 2024-10-06
oldSlug: /blog/4
...
- #### Summary of the report's Demands / Markets section
  ...
  [Investing in Creativity](https://www.urban.org/sites/default/files/publication/50806/411311-Investing-in-Creativity.PDF) addresses the public's demand for artists and their work, and how that demand translates into financial compensation. Key points include:

  1. Artists work across multiple sectors: commercial, nonprofit, public, and informal.
  2. Artists often engage in multiple markets simultaneously or over the course of their careers.
  3. The report distinguishes between culture-specific markets and hybrid markets (arts intersecting with other fields).
  4. Artists, institutions and funders typically associate "market demand" only with the commercial sector, overlooking other opportunities.
  5. Intermediaries play a crucial role in connecting artists to markets, but more are needed.
  6. Universities and art schools often do little to help graduates access to job markets.
  7. National networks and artists' alliances have untapped potential to strengthen demand for artists.
  8. Hybrid markets are seen as promising but underdeveloped, lacking adequate support structures, validation mechanisms, and documentation.
...
- Commercial or non-commercial, where artists may:

  - Sell work in a gallery or publishing records,   
    or
  - Produce experimental/non-commercial art, teach, work as administrators and curators, facilitate community engagement
- Conventional or hybrid, where artist may:

  - Produce studio work and exhibit it in galleries and museums, record music and publish it at record labels,   
    or
  - Work in non-art contexts or at the intersection of arts and other fields: in *hybrid art markets*
...
This "2-cultures" syndrome is yet another unfortunate consequence of our tradition of divisions, about which I have a rant published [elsewhere](https://mnartists.walkerart.org/unlearning-the-elephant-against-multidisciplinarity). To remedy it, we need to reframe both the culture and the artists' role in it.
...
1. Many artists are interested in embedding their creative practice in non-arts contexts;
2. There's significant demand for artists' skills in non-arts sectors;
3. The apparent match of supply and demand fails to materialize into a market due to the barriers of information and language, as well as the failure to place value on artists’ work (lack of validation).
...
The theory was (and still mostly is) that these can be overcome by "[placing](https://en.wikipedia.org/wiki/Artist_Placement_Group)" artists in residencies in non-art contexts, facilitating social environments where artists can interact with non-artists and work out the communication. Thus, relationships would organically flourish, leading to collaborations and innovations. This would result in publications and exhibitions, fulfilling the need for validation and information. All that, in turn, will lead to the eventual collapse of the proverbial silos.
