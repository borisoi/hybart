---
title: "On Arts, AI and Human Rights: Interview with Caroline Sinders"
date: 2024-10-30
oldSlug: /blog/5
...
- #### Interview Takeaways
  ...
  - Her approach to collaboration is deeply ethical, emphasizing working "at the speed of trust" with communities while ensuring fair compensation and meaningful knowledge exchange.
  - Though she works across sectors of art and human rights advocacy, 80% of her funding comes from human rights work rather than arts funding, with European funders showing more openness to interdisciplinary projects than their US counterparts.
  - She advocates for funding structures that embrace multiple types of deliverables rather than requiring predetermined artistic outcomes.
  - A major challenge in her practice is the institutional separation between art and human rights work, which makes it difficult to secure support for projects that bridge these fields.
...
But it's not theoretical. I'm always thinking about how art can be useful in a practical sense. How can we use creativity to galvanize people towards action? That's the real power of this work - it can touch people emotionally through artistic elements while also informing them through research.
...
**CS**: It is [*digital rights*](https://en.wikipedia.org/wiki/Digital_rights), which is about the way human rights manifest in technology.

For example, we might look at Alexa, which includes both hardware and software components. There are so many aspects to consider - the materials used, the policies around obtaining those materials, the company's policies in assembling the product, and even the policies that apply when you purchase it in different countries. Digital rights looks at all these systems.

In one aspect of my work, I focus on how design impacts policy. For instance, if you've ever thought you unsubscribed from a service but didn't, you've encountered a manipulative design that can unintentionally or intentionally nudge consumers to make decisions they wouldn't otherwise make. We call these things [*dark patterns*](https://en.wikipedia.org/wiki/Dark_pattern)or *harmful design patterns*.

I also look at how hate speech manifests on social media, and how technology facilitates gender-based violence. From a digital rights perspective, you could look at how hate speech directly impacts people depending on where they live or their identity - for example, if they're facing online gender-based violence, homophobia, transphobia, Islamophobia, anti-Semitism, and so on.
...
This involves considering how everything is made - creating and training datasets, but also the working conditions of people in machine learning: the low-paid, often invisible workers who refine or train datasets. How people work inside AI matters just as much as how we train our models to ensure equity and diversity in the outputs.

Another aspect of AI that I am working on is educating consumers about how this technology is used in products. For example, I've been working with civil society organizations on studying the recommendation algorithms for social media.
...
In India, we worked with journalists who were facing various types of restrictions and censorship, as well as policy experts. In Louisiana, our partners were abortion activists and researchers, as well as secret mutual aid groups and institutionalized abortion funds.

In both locations our focus was secure communication, which is extremely important in both locations to protect the work from outside interventions, and people - from persecution. We worked to understand the challenges to encrypted and secure communication in these two very different contexts, journalists in India and the reproductive justice movement in Louisiana, and what they share in terms of needs for safe communication.

As we engaged with these communities, we observed specific knowledge gaps they had. This led us to distributing materials and knowledge about safer communication practices and providing security training. We paid people for their time and also engaged in an exchange of labor, providing security support that was tailored to people’s needs.
...
**CS:** Before I take on any project, I go through a deep analysis. I ask myself: Why me? Do we have the right skills for this? Why is this question important here and now? Why hasn't it been done before? What are the barriers to deal with? Do I have the right knowledge and background?
...
**BO:** Let's talk about how your work is supported. What does your practice look like financially?

**CS:** That's a great question, and I appreciate you asking. I wish more people in our field would talk about this - money and the nitty-gritty of running a collaborative art practice.

My income is split across many different sources. I'm an adjunct professor, I have fellowships, I run a small human rights lab called [Convocation Research and Design](https://convocation.design/about/), and I do a lot of freelance writing and research. I'm also constantly pitching and hustling for grants, looking for new projects, applying to requests for proposals, or filling in for other human rights organizations.
...
**BO:** Finally, can you recommend artists who inspire you?

**CS:** Absolutely. First, I'd mention [Amelia Winger-Bearskin](https://www.studioamelia.com/), a fantastic AI artist, filmmaker, and new media artist doing interesting work on indigeneity and speculative futures.

Another group I'm a big fan of is [Superflux](https://superflux.in/). Their work is really exemplary of how design can intersect with current social and technological issues.

I'd also recommend [Superrr Lab](https://superrr.net/). Some people might categorize them more in the human rights or digital rights space, but I see their work as very much artistic. They've done some great work on data feminism and futurism.

Other artists in this field are [Mimi Onuoha](https://mimionuoha.com/) and [Adam Harvey](https://adam.harvey.studio/), also working at the intersection of art, data, and research.
...
**BO:** This is a great place to end, thank you!
